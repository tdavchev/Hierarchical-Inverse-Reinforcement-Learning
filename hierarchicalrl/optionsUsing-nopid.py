...
option_goal = [45, 80, 100, 136]
endGoal = option_goal[option]#[2]
room_no = [0, 0, 1, 1, 2, 2, 3, 3]
...
policy_actions_0 = [np.argmax(Q[i, 2, :, 0]) for i in xrange(S)]
policy_actions_2 = [np.argmax(Q[i, option, :, gID]) for i in xrange(S)]
print len(policy)
