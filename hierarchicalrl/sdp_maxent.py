...
def irl(option_states, feature_matrix, n_actions, discount, transition_probability,
    ...
    for i in range(epochs):
        ...
        expected_svf = find_expected_svf(option_states, n_states, r, n_actions, discount,
...
def find_expected_svf(options_states, n_states, r, n_actions, discount,
                      transition_probability, trajectories):
    """
    ...
    policy = value_iteration.find_policy(options_states, n_states, n_actions,
